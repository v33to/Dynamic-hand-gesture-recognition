...
[![IMAGE ALT TEXT HERE](https://img.youtube.com/vi/pz4kWe5baD8/0.jpg)](https://www.youtube.com/watch?v=pz4kWe5baD8)
...
```bash
git clone https://github.com/v33to/Dynamic-hand-gesture-recognition.git
```
